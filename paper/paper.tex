...
Der Algorithmus, den wir uns zu der Konstruktion des Suffixarrays anschauen, ist DC3\footnote{Der Algorithmus ist in \cite{Karkkainen2006} vorgestellt worden ist.} (steht für Difference Cover modulo 3) genannt worden. Die Schritte des Algorithmus werden mit einem Beispiel veranschaulicht. Als Eingabe haben wir das Wort
...
Die Schritte des Algorithmus wird wie folgt ausgeführt:
\begin{enumerate}
