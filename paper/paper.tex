...
Suffixarray $SA[0,n]$ eines Wortes $T[0,n)$ ist eine Permutation von $[0,n]$ mit der Eigenschaft $S_{SA[0]} \prec S_{SA[1]} \prec \dots \prec S_{SA[n]}$, wobei die $\prec$--Relation die lexikographische Ordnung auf Wörter bezeichnet.  
...
\textbf{Schritt 1: Konstruktion der Mustersuffixe}
...
Sei $C = B_1 \cup B_2$ die Menge der Musterpositionen und $S_C$ ist die Menge der Mustersuffixe. In unserem Beispiel:
$$
