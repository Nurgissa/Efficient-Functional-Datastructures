...
Abb. \ref{fig:sigmaPlusTree} zeigt einen $\Sigma^+$-Baum für $\Sigma = \{a, \dots, g \}$
...
Im Abschluss des Kapitels möchten wir zeigen, dass mit dem erzeugten Suffixbaum kann man nicht nur Suffixe effezient suchen, sondern auch Teilwörter vom gegebenen Wort. Dafür definieren wir eine Hilfsfunkktion, die ähnlich wie die $edge$-Funktion arbeitet:
