...
Esrte Funktion ist $suffixes$, die eine Suffixliste von einem gegebenen Wort zurückliefert. 
...
Dank der laziness-Eigenschaft, werden nur die Kanten vom Suffixbaum während der Suche konstruiert, die für die Suche relevant sind. Der Rest vom Suffixbaum wird gar nicht angeschaut. Diese Eigenschaft zeigen wir an einem Beispiel.

Sei ein Teilwort $cgac$ im Wort $agcgacgag$ gesucht.
