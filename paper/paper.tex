...
Der Durchbruch gelang erst zwei Jahrzehnte später mit
\end{abstract}
...
Sei $t = uvw$  eine beliebige Zerlegung von $t$ mit $u, v, w \in \Sigma^*$. Dann ist $u$ ein Präfix und $w$ ein Suffix von $t$. $v$ wird als $t$-Wort bezeichnet.
\end{definition}
