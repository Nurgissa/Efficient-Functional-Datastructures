...
\frametitle{Notation}
\begin{itemize}
    \item Suffixarray $SA$ von $T$ ist eine Permutation von $[0,n]$ mit $S_{SA[0]} \prec S_{SA[1]} \prec \dots \prec S_{SA[n]}$, wobei $\prec$ lexikographische Ordnung auf Zeichenketten bezeichnet.
\end{itemize}
\begin{example}
\begin{itemize}
