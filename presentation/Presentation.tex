...
\begin{itemize}
    \item Jedes $t$-Wort $w$ lässt sich darstellen als $t = vs, s = wu$
          ...
          \end{gather*}
    \item Suche im Suffix Tree: Präfixsuche auf Suffixen
...
\frametitle{Suffix Tree Klassen}
\begin{definition}
Sei $S_t$ ein Suffix Tree für ein Wort $t$, repräsentiert durch seine Kantenmenge $E$. $S_t$ wird bezeichnet als:
\begin{itemize}
...
\begin{tikzpicture}
    \node (n1) {
        \begin{tabular}{l|c c c c c c c c c c c c}
            ...
            Wort & y  & a & b & b & a & d & a & b & b & a & d & o  \\
            \midrule
            Rang & 11 & 0 & 6 & 4 & 2 & 8 & 1 & 7 & 5 & 3 & 9 & 10 \\
            \bottomrule
        \end{tabular}
    };
    \node[below = 2cm] (n2) {
