...
\begin{definition}
Sei $D = \{s_1, \dots, s_n\}$ eine Menge von Strings über $\Sigma$. $T = \{t_1, \dots, t_n\}$ eine Menge von Terminalsymbolen mit $T \cap \Sigma = \emptyset$. Ein GST $S_D$ ist ein $\Sigma^+$-Baum, sodass für alle $i \leq n$ gilt:
\begin{gather*}
    w \in S_D \Longleftrightarrow w \text{ ist ein } s_it_i\text{-Wort}
\end{gather*}
\end{definition}
\vspace{-3mm}
\begin{example}
...
TODO Anwendungsgebiet auswählen und vorstellen!
\end{frame}
%--Folie---------------------------------------------------------------------
