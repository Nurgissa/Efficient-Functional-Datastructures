...
\begin{frame}
    ...
    \end{definition}
    \begin{definition}
        Ein Suffix von $t$ heißt verschachtelt, wenn es mehrmals in $t$ vorkommt, d.h. $t = uvwv$ mit $u, v, w \in \Sigma^*$.
    \end{definition}
    \begin{example}
        $ag$ ist ein verschachteltes Suffix von $agcgacgag$.
    \end{example}
\end{frame}
%--Folie-----------------------------------------------------------
...
%--Folie: Position Suffix Tree and Compact Suffix Tree-------------
\begin{frame}
