...
$$\left\{\left(i,j\right)\vert\: i \in \left\{1, 2\right\},\: j \in \left\{1, \dots, 4\right\}\right\}$$
ist äquivalent zu
$$\left[\left(i, j\right)\vert\: i \leftarrow \left[1,2\right],\: j \leftarrow \left[1..4]\right]\right$$
Syntax: $\left[e \:\vert\: q_1, \dots, q_n]\right, n \geq 1$ , wobei die $q_i$ entweder 
\begin{itemize}
...
% TODO: Beispiel für List comprehension mit lokaler Definition hinzufügen!
\end{enumerate}
\end{examples}
\end{frame}
%--Folie-----------------------------------------------------------------------
