...
\begin{block}{Samples erzeugen}
    \begin{columns}
        ...
        \column{.5\textwidth}
        \begin{tikzpicture}
               \node (n1) {\color{gray}ya\color{blue}b\color{gray}ba\color{blue}d\color{gray}ab\color{blue}b\color{gray}ad\color{blue}o};
               \node[below = 2cm] (n2) at (n1) {\color{black}[\color{blue}b\color{gray}ba\color{black}][\color{blue}d\color{gray}ab\color{black}][\color{blue}b\color{gray}ad\color{black}][\color{blue}o\color{gray}00\color{black}]};
               \path[->, color = blue] (n1) edge (n2);
        \end{tikzpicture}
    \end{columns}
\end{block}
\end{frame}
