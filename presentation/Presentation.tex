...
commonPrefix w1 w2 = g w1 w2 []
    where
    g (x:xs) (y:ys) cp | (x == y) = g xs ys (x:cp)
...
\frametitle{Notation}
\begin{itemize}
    \item Suffixarray $SA$ von $T$ ist eine Permutation von $[0,n]$ mit $S_{SA[0]} \prec S_{SA[1]} \prec \dots \prec S_{SA[n]}$, wobei $\prec$-Relation kleiner-Relation über strings ist. 
\end{itemize}
\begin{example}
\begin{itemize}
    \item Suffixarray für $yabbadabbado$ ist $SA = (12,1,6,4,9,3,8,2,7,5,10,11,0)$, wobei
    % \begin{table}
    %     \begin{tabular}{l|l}
    %         \toprule
    %         i & 13 \\
...
%////////////////////////////////////////////////////////////////////////////
\subsection{Kärkkäinen-Sanders Algorithmus}
%////////////////////////////////////////////////////////////////////////////
...
\end{description}
Die Elemente von $R$ werden mit Radix-Sort sortiert, um den Rang festzustellen:
\begin{table}
    ...
    \end{tabular}
\end{table}
$R$ wird in $R'$ umgewandelt durch Ersetzen der Elementen mit seinen Ränge:                                                     \\
$R' = (1,2,4,6,4,5,3,7)$
\end{frame}
%--Folie---------------------------------------------------------------------
