...
% Suffix Tree Layout
% \tikzstyle{level 1}=[level distance=8mm, sibling distance=35mm]
% \tikzstyle{level 2}=[level distance=8mm, sibling distance=20mm]
% \tikzstyle{level 3}=[level distance=8mm, sibling distance=15mm]
...
\begin{tikzpicture} [
    font = \small,
    level/.style = {sibling distance = 3cm/#1, level distance = 7mm},
